        ...
        (module.exports = function ($, _) {
          ...
          function addListeners() {
            ...
            $doc.on("submit", namespace + " form", function (evt) {
              ...
              $.ajax({
                type: "POST",
                url: "https://truthmemes.io:8085/subscribe.php",
                data: $("form").serialize(),

                success: function (response) {
                  console.log("success");
                  document
                    .querySelectorAll(".status-message.cc-success-message")
                    .forEach((a) => (a.style.display = "block"));
                  document
                    .querySelectorAll(".status-message.cc-error-message")
  ...
  events: {
    "e-3": {
      ...
      target: {
        selector: ".slide-2",
        originalId:
          "65378474aa0592cfa1acabdb|1f09a057-2088-f594-50b6-f4f43fcb1fc3",
        appliesTo: "CLASS",
      },
      targets: [
        {
          ...
          actionItems: [
            {
              ...
              config: {
                ...
                target: {
                  ...
                  selectorGuids: ["7bce711c-f758-7b41-988e-2c0b226b1b01"],
                },
                xValue: 1,
                yValue: 1,
                locked: true,
